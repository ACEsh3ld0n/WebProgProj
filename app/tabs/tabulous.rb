...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #------------------------------------------------------------------------------------------------------#
      [    :players_tab    ,    'Players'       ,    players_path          ,    true        ,    true        ],
      [    :welcome_tab    ,    'Home'          ,    welcome_index_path    ,    true        ,    true        ],
      [    :new_tab        ,    'New'           ,    new_player_path       ,    true        ,    true        ],
      #------------------------------------------------------------------------------------------------------#
      #    TAB NAME        |    DISPLAY TEXT    |    PATH                  |    VISIBLE?    |    ENABLED?    #
      #------------------------------------------------------------------------------------------------------#
    ]
  ...
  #
   config.css.background_color = 'charcoal'
  # config.css.text_color = '#444'
   config.css.active_tab_color = '#1d98c6'
   config.css.hover_tab_color = '#ddd'
  # config.css.inactive_tab_color = '#aaa'
  config.css.inactive_text_color = 'white'
